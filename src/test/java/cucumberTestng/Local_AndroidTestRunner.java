...
@CucumberOptions(features = "src/main/resources/Features/", format = { "pretty",
        ...
        tags = {"~@ignore"})
public class Local_AndroidTestRunner extends AbstractTestNGCucumberTests {
    ...
    public static void init() throws Throwable {
        ...
        try {
            ...
            MobileApp.logger = MobileApp.report.startTest("Installing pre requisites for local android...");
