...
@CucumberOptions(features = "src/main/resources/Features/OM_Tasks.feature", format = { "pretty",
        ...
        tags = {"~@ignore"})
public class SL_AndroidTestRunner extends AbstractTestNGCucumberTests {
    ...
    public static void init() throws Throwable {
      ...
      //  System.out.println("Running pre req status : " + fileName);
        ...
        try {
            ...
            MobileApp.logger = MobileApp.report.startTest("Installing pre requisites on Sauce Labs for android...");
