...
#    When   Provide Security Pin as 0000
  ...
  @OM-201
  Scenario: Verify the Message sending functionality without entering the mandatory fileds.
  ...
  @OM-15
  Scenario Outline: Verify the sent message is displaying in Sent Messages tab
    ...
    Examples:
      ...
      | Automation Created  |   Test Body | Adam Ellis    |
